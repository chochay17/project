...
<div class= "img js-fullheight" style="background-image: url(img/img-bg/bg-2.jpeg);">   <!-- bg -->
   ...
   <div class="form-group mb-4">
    ...
    <div class="row">
        ...
        //แสดงข้อมูล
        $sql = "SELECT * FROM sh_product WHERE type_id=3 limit {$start}, {$perpage} ";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item"><a class="page-link" href="sh_product3.php?page=1">Previous</a></li>
   <?php for ($i = 1;$i<=$total_page;$i++) { ?>
    <li class="page-item"><a class="page-link" href="sh_product3.php?page=<?=$i?>"><?=$i?></a></li>
   <?php } ?>
    <li class="page-item"><a class="page-link" href="sh_product3.php?page=<?=$total_page?>">Next</a></li>
  </ul>
</nav>
