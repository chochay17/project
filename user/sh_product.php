...
<div class= "img js-fullheight" style="background-image: url(img/img-bg/bg-2.jpeg);">   <!-- bg -->
   ...
   <div class="form-group mb-4">
    ...
    <div class="row">
        ...
        //แสดงข้อมูล
        $sql = "SELECT * FROM sh_product WHERE type_id = 1 limit {$start}, {$perpage} ";
        ...
        <div class="col-md-3 mt-3"  >
            ...
            <a href ="cart.php" > <img src="img/<?=$row['img']?>" width="240" height="250" class=" p-2 my-2 bg-white border" ></a> <br>
            ID: <?=$row['pro_id']?> 
