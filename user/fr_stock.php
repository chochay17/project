...
<div class="card-body">
   <div class="form-group mb-4">
       <table class="table table-striped  table-hover table-responsive table-bordered"></table>                                
                    ...
                    <form name="form1" method="post" action="save_stock.php" enctype="multipart/form-data">
                        ...
                        <label>ราคา: </label>
                        <input type="number" name="price" class="form-control" placeholder="ราคา...." required > <br>  <!--cho-->
                        <label>จำนวน: </label>
