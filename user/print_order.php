   ...
   <div class="form-group mb-4">
       <table class="table table-striped  table-hover table-responsive table-bordered"></table>
            ...
            <table class="table table-hover">
                ...
                <tbody></tbody>
<?php
$sql1="select * from order_detail d,sh_product p where d.pro_id=p.pro_id and d.orderID= '" . $_SESSION["order_id"] . "' ";
...
?>          
   ...
   <a href="sh_product.php" class="btn btn-success">Back</a>
